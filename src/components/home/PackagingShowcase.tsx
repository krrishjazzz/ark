  ...
  return (
    <FadeIn delay={0.1}>
      ...
      >
        ...
        {/* Idle label */}
        <div className="absolute bottom-4 left-4 right-4 transition-all duration-500 group-hover:opacity-0 group-hover:translate-y-2 pointer-events-none">
        ...
        {/* Hover reveal */}
        <div className="absolute inset-0 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity duration-500 pointer-events-none">
          ...
          <div className="relative h-full flex flex-col items-center justify-center text-center px-5 sm:px-8">
            ...
            <div className="grid grid-cols-2 gap-2 w-full max-w-xs mb-5 translate-y-3 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 delay-300">
            ...
            <p className="font-button text-[9px] uppercase tracking-[0.22em] text-gold/80 translate-y-3 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 delay-[350ms]">
              Ready for the wall
            </p>
          </div>
        </div>
